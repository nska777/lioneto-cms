...
export interface ApiGlobalGlobal extends Struct.SingleTypeSchema {
  ...
  attributes: {
    addresses: Schema.Attribute.Component<'shared.region-address', true>;
    callCtaLabel: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    phones: Schema.Attribute.Component<'shared.region-phone', true>;
    publishedAt: Schema.Attribute.DateTime;
    regionPromt: Schema.Attribute.String;
    socials: Schema.Attribute.Component<'shared.social', true>;
    topLinks: Schema.Attribute.Component<'shared.link', true>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiLionetoSettingLionetoSetting
  extends Struct.SingleTypeSchema {
  collectionName: 'lioneto_settings';
  info: {
    displayName: 'Site Settings';
    pluralName: 'lioneto-settings';
    singularName: 'lioneto-setting';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::lioneto-setting.lioneto-setting'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    showLanguageToggle: Schema.Attribute.Boolean;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiNewsItemNewsItem extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    title: Schema.Attribute.String & Schema.Attribute.Required;
    type: Schema.Attribute.Enumeration<['arrival', 'update', 'sale', 'event']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
